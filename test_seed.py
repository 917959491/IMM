...
if __name__ == '__main__':
    ...
    path = "/home/ljx/Ljx/PeopleWeb/ToupleGDD _Final/test_data/PeopleWeb.txt"
    # number of parallel processes
    num_process = 5
    # number of trials
    num_trial = 10000
    # load the graph
    graph = read_graph(path, ind=0, directed=False)
    print('Generating seed sets:')
    list_S = []
    #ToupleGDD得到的节点集
    list_S.append([142, 72, 564, 984, 114])
    #S2V-DQN得到的节点集
    list_S.append([2323, 72, 488, 984, 2341])
    #随机生成的节点集
    for _ in range(8):
